...
That directly addresses the reviewer's **criterion one** concern.

---

# 2. Fix `pyproject.toml`

The reviewer noticed that you haven't declared a build backend.

Add this at the **top** of `pyproject.toml`:
